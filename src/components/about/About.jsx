...
const FoldingLogos = () => {
    return (
        <section className="flex items-center justify-center px-0 py-16 md:flex-row">
            <LogoRolodex
                items={[
                    ...
                    <LogoItem key={3} className="bg-red-400 text-neutral-900">
                        <SiRust />
                    </LogoItem>,
                    <LogoItem key={4} className="bg-blue-300 text-black">
                        <SiDotnet />
                    </LogoItem>,
                    <LogoItem key={5} className="bg-blue-600 text-neutral-900">
                        <SiCsharp />
                    </LogoItem>,
                ]}
            />
          ...
          <div className="space-y-4">
            <Reveal>
              ...
              <span className="bg-indigo-500 text-white py-2 px-3 rounded font-bold mr-1 float-left text-2xl">
                ...
                ey! I&apos;m Jacob. I&apos;m a student at TECHCOLLEGE for programming where I specialize in the backend, primarily Rust, but love building with whatever tools are right for the job.
              </p>
            </Reveal>
            <Reveal>
              <p className="leading-relaxed text-zinc-300">
