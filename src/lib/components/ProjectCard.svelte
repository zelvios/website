<script>
    ...
    function report() {
        if (descEl) {
            dispatch('reportHeight', descEl.offsetHeight);
        }
    }
...
<main>
    <div bind:this={rootEl} class="group relative flex flex-col w-[360px] min-w-0 mb-10 h-full">
        <div class="relative overflow-hidden rounded-2xl bg-slate-950 shadow-2xl transition-all duration-300 hover:-translate-y-1 hover:shadow-accent/15 flex flex-col h-full">
            ...
            <div class="relative p-6 flex-1 flex flex-col">
                    ...
                    <a class="block hover:underline"
                       ...
                       target="_blank">
                        ...
                        <img
                                ...
                                src={`https://raw.githubusercontent.com/zelvios/${repo.name}/main/.github/screenshots/design.png`}
                                on:load={report}
                        />
                    </a>

                    <GradientLine glowOpacity={0.8} height={1}/>

                    <p class="repo-desc text-slate-400 mt-6 mb-0" bind:this={descEl}>
                ...
                <div class="mt-6 flex items-center justify-between">
                    <div class="flex items-center gap-2">
                        <a aria-label={`Go to ${repo.name} GitHub repository`}
